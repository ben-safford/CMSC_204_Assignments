...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		try {
			...
			assertEquals(1.5, doubleQ.dequeue());
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(2.5));
	...
	public void testToStringStudent() throws QueueOverflowException {
		assertEquals("1.0 1.5 2.0", doubleQ.toString(" "));
		doubleQ.enqueue(2.5);
		assertEquals("1.0 1.5 2.0 2.5", doubleQ.toString(" "));
		doubleQ.enqueue(3.0);
		assertEquals("1.0 1.5 2.0 2.5 3.0", doubleQ.toString(" "));
	}
